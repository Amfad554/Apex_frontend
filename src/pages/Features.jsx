            ...
            <section style={{ padding: '0 1.5rem clamp(4rem, 8vw, 6rem)' }}>
                <div style={{
                    ...
                    <div style={{
                        ...
                        height: 4, background: T.orange,
                    }} />
                    <div style={{
                        position: 'absolute', top: -60, right: -60,
                        width: 220, height: 220, borderRadius: '50%',
                        background: `${T.orange}14`, pointerEvents: 'none',
                    }} />
                    <div style={{
                        position: 'absolute', bottom: -50, left: -50,
                        width: 180, height: 180, borderRadius: '50%',
                        background: T.softNavy, pointerEvents: 'none',
                    }} />
                    ...
                    <p style={{
                        ...
                        Join our network today and get your medical facility verified
