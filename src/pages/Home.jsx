...
export default function Home() {
    ...
    useEffect(() => {
        const target = { patients: 50000, hospitals: 250, doctors: 1500, uptime: 99.9, rating: 4.9 };
        const duration = 2000;
                ...
                <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 text-center">
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
                        ...
                        <div className="flex items-center justify-center gap-4 mb-6">
                            ...
                            <div className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-bold">Live</div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="relative group bg-gradient-to-br from-indigo-600 to-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-indigo-200 hover:shadow-2xl hover:shadow-indigo-300 transition hover:-translate-y-1 cursor-pointer"
                        ...
                        <motion.div
                            ...
                            className="relative group bg-white rounded-3xl p-8 border-2 border-slate-100 hover:border-green-400 shadow-lg hover:shadow-xl transition hover:-translate-y-1 cursor-pointer"
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 font-bold text-green-600 group-hover:gap-4 transition-all">
                        ...
                        <motion.div
                            ...
                            className="relative group bg-white rounded-3xl p-8 border-2 border-slate-100 hover:border-pink-400 shadow-lg hover:shadow-xl transition hover:-translate-y-1 cursor-pointer"
                            onClick={() => navigate("/patientlogin")}
                        >
                            <div className="absolute top-4 right-4 bg-pink-100 text-pink-700 text-xs font-bold px-3 py-1 rounded-full">
                                By Invite
                            </div>
                            ...
                            <div className="flex items-center gap-2 font-bold text-pink-500 group-hover:gap-4 transition-all">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="relative max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                            <FlowCard title="Public Platform"
                                items={["Hospital Registration", "Hospital Login", "Super Admin Login"]} color="blue" />
                            <FlowCard title="Super Admin Panel"
                                items={["Approve Hospitals", "Monitor Activities", "Manage Platform"]} color="purple" />
                            <FlowCard title="Hospital Dashboard"
                                items={["Patient Management", "Staff & Appointments", "Medical Records"]} color="green" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <RoleCard icon={<Shield />} title="Super Admin" color="red"
                            permissions={["Approve hospital registrations", "Monitor all platform activity", "Suspend/delete hospitals", "Manage system settings"]} />
                        <RoleCard icon={<Building2 />} title="Hospital Admin" color="blue"
                            permissions={["Manage hospital profile", "Add/remove staff members", "Register patients", "Full hospital access"]} />
                        <RoleCard icon={<Stethoscope />} title="Doctors & Staff" color="green"
                            permissions={["View assigned patients", "Add medical records", "Manage appointments", "Update prescriptions"]} />
                        <RoleCard icon={<Heart />} title="Patients" color="pink"
                            permissions={["Registered by hospital", "Access medical records", "View appointment history", "Secure patient portal"]} />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                    <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12 border border-slate-100">
                        ...
                        <form className="space-y-4">
                            ...
                            <textarea placeholder="Message or Questions" rows="4"
                                className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
                            <button type="submit"
