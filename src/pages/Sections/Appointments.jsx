...
export function Appointments({ hospital, isMobile }) {
    ...
    const pageStyle = {
        background: PALETTE.navy, minHeight: '100vh',
        ...
        <div style={pageStyle}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28, gap: 12 }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        background: `linear-gradient(135deg, ${PALETTE.orange} 0%, #FF8C55 100%)`,
                                ...
                                {a.status === 'scheduled' && (
                                    <div style={{ display: 'flex', gap: 6 }}>
                                        <button onClick={() => updateStatus(a.id, 'completed')}
                                            style={{ flex: 1, padding: '7px', background: 'rgba(16,185,129,0.15)', border: 'none', borderRadius: 8, color: ACCENT.green, fontWeight: 600, fontSize: 12, cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s ease' }}
                                        ...
                                        <button onClick={() => updateStatus(a.id, 'cancelled')}
                                            style={{ flex: 1, padding: '7px', background: 'rgba(239,68,68,0.1)', border: 'none', borderRadius: 8, color: ACCENT.red, fontWeight: 600, fontSize: 12, cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s ease' }}
            ...
            {showBook && (
                <div
                    ...
                    style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 9999, overflowY: 'auto', padding: isMobile ? '16px' : '40px 20px', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', minHeight: '100vh' }}
                >
