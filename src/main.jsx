...
const StaffAuthGuard = () => {
  const token = getToken();
  const user  = getUser();
  // Accepts any role that is NOT a hospital_admin or patient — covers doctor,
  // nurse, pharmacist, lab_technician, receptionist, admin, staff, and any
  // future roles the backend may introduce.
